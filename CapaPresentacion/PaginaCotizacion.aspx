                    ...
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="auto-style5">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtCantidad" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="true" OnTextChanged="txtCantidad_OnTextChanged"></asp:TextBox>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtCostoDiseno" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="true" OnTextChanged="txtCostoDiseno_OnTextChanged"></asp:TextBox>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtCavidad" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="true" OnTextChanged="txtCavidad_OnTextChanged"></asp:TextBox>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtValorpapel" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="auto-style5">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtMontaje" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtImpresionestotales" runat="server" CssClass="form-control" TextMode="Number" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtCantidadpliego" runat="server" CssClass="form-control" TextMode="Number" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtvalorplancha" runat="server" CssClass="form-control"  Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtValorImpresion" runat="server" CssClass="form-control"  Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtValorTotalPapel" runat="server" CssClass="form-control"  Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList ID="ddFrente" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddFrente_SelectedIndexChanged" CssClass="form-control" >
                            ...
                            <div class="col-md-2">
                                ...
                                <div>
                                    <asp:TextBox ID="txtFrente" runat="server" CssClass="form-control" TextMode="SingleLine" AutoPostBack="true" OnTextChanged="txtFrente_OnTextChanged" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList ID="ddRespaldo" runat="server" AutoPostBack="True" CssClass="form-control"   OnSelectedIndexChanged="ddRespaldo_SelectedIndexChanged"  >
                                        <asp:ListItem Value="Si">Si</asp:ListItem>
                                        <asp:ListItem Value="No">No</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtRespaldo" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="true" OnTextChanged="txtRespaldo_OnTextChanged" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList ID="ddMismaplancha" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddMismaplancha_SelectedIndexChanged">
                                        <asp:ListItem Value="Si">Si</asp:ListItem>
                                        <asp:ListItem Value="No">No</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtValorTotalImpresiones" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtValorTotalplancha" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtTotalAcabados" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtSubtotalFactura" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                </div>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtTotalfactura" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtValorGanancia" runat="server" AutoPostBack="false" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </td>
                                <td style="width: 10px"></td>
                                <td style="width: 100px">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtPorcentajeGanancia" CssClass="form-control" Style="width: 100px" runat="server" AutoPostBack="true" OnTextChanged="txtPorcentajeGanancia_OnTextChanged"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                        </table>
